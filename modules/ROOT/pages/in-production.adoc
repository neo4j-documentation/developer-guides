...
Cloud-hosted offerings and how to deploy Neo4j to infrastructure or platform providers is documented and referenced in the xref:guide-cloud-deployment.adoc[cloud] and xref:aura-cloud-dbaas.adoc[Neo4j Aura] sections.
