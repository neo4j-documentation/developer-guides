...
// video here - once it is uploaded

=== Deplyoying the Backend and Frontend with Heroku

You will have to create two apps on Heroku, one for the backend and one for the frontend. 
...
Create another Heroku app for the frontend. 
Add another git remote pointed to the Heroku app dedicated to the frontend app. 
