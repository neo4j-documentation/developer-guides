...
a|https://youtu.be/NF_KVbqHw7Q[Catch-up Link^]
...
a|https://youtu.be/1B1n38WmBm8[Catch-up Link^]


|**3 December** +
_6am PST, 9am EST, 2pm UTC, 3pm CET, 7:30pm IST_
|Guests Julian Gomez and Shilpa Karkeraa, with co-hosts Nathan Smith & Lju Lazarevic
a|*NODES2020 Extended*
...
|Guests Monojit Basu, Aleksandra Asanin and Ruben Teijeiro, with co-hosts Alexander Erdl and Lju Lazarevic
a|*NODES2020 Extended*

* Manifold structures in semi-supervized and multiview learning
* How Neo4j helps in the recruiting process
...
|**9 December** +
_3:30pm UTC, 4:30pm CET, 9pm IST_, 11:30pm AWST, 1:30am AEST, 3:30am NZST
|Guests Eric Solender and Florent Biville
a|*Neo4j Streams*

* Introduction to https://github.com/mindstand/gogm[GoGM^]
...
Don't know drivers? Can't query? Starting out with a new stack? Bring your questions to our AMA sessions, and our experts will talk you through it. 
