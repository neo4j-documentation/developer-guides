...
// :page-ad-title: Free, Self-Paced, Hands-on Online Training
// :page-ad-description: Learn how to build, optimize and launch your Neo4j project, all from the Neo4j experts.
// :page-ad-link: https://graphacademy.neo4j.com/?ref=guides
// :page-ad-underline: Start Learning Now
