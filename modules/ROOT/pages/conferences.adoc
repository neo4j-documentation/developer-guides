= Meet Neo4j at a Conference
:slug: conference
:section: Documentation and Resources
:category: documentation
:tags: confernce, meetup, talk, events, developer, training

image::https://devnexus.com/assets/img/devnexus-logo.png[width="300px",float="right"]
...
=== Neo4j AuraDB
image::https://github.com/neo4j-documentation/developer-guides/blob/db9d998bea2ab0fad307cbb6824be5c8cd19b271/modules/ROOT/images/Neo4jauraDB.png[width="300px",float="right"]
