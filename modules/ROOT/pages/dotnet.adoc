...
:page-deprecated-redirect: https://neo4j.com/docs/getting-started/current/languages-guides/neo4j-dotnet/
...
In this free course, we walk through the steps to integrate Neo4j into your .NET projects.
You will learn about the Neo4j .NET Driver, how sessions and transactions work, how to query Neo4j and process results.
