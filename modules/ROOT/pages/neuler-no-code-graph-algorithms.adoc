...
We can get the installation link by clicking on the image:graph-algorithms/get-link.png[width="20px"] button.
Copy that link onto the clipboard and then paste it into the 'Install' section of the image:graph-algorithms/graph-apps-button.png[width="20px"] sub menu:
