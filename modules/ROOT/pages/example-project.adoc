...
image::https://github.com/neo4j-graph-examples/movies/raw/main/documentation/img/model.svg[width=400]

And example subgraph of the data is the neighborhood of "Tom Hanks".

image::https://github.com/neo4j-graph-examples/movies/raw/main/documentation/img/example.png[width=400]
