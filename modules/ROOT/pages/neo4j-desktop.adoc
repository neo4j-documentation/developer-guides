...
link:link:/download/?ref=developer-neo4j-desktop[If you haven't already, download Neo4j Desktop Now^, role="button feature-box_button"]
...
Neo4j Desktop comes with an free Developer License of Neo4j Enterprise Edition, the Java Runtime is also bundled.
...
image::{img}first_graph_experience.png[float="right"]
...
image::{img}deleting_a_project.jpg[float="right"]
