...
If you're using link:https://neo4j.com/cloud/aura/?ref=developer-guides[AuraDB] congratulations, you're already done with this section.  APOC core functions are already built in.  The rest of this section is for users who run Neo4j in a self-managed mode.
