...
:page-deprecated-redirect: https://neo4j.com/docs/getting-started/current/#_the_neo4j_graph_data_platform
...
This guide introduces the different products we provide at Neo4j to suit your diverse business and technology needs and shows you how to get started using them.
...
* link:/developer/aura-cloud-dbaas/[Neo4j AuraDB] - database-as-a-service offering managed by Neo4j for graph databases in the cloud. Find out more general information on the link:/aura/[product page^].
