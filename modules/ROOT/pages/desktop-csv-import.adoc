...
+
image::{img}generic-open_terminal.png[role="popup-link"]
+
...
.Results in Neo4j Browser:
image:{img}developer-desktop-csv-import-test_load_1.png[role="popup-link"]

image:{img}developer-desktop-csv-import-test_load_2.png[role="popup-link"]

image:{img}developer-desktop-csv-import-test_load_3.png[role="popup-link"]
...
image:{img}developer-desktop-csv-import-FilterCSV.png[role="popup-link"]
...
image:{img}developer-desktop-csv-import-products_convert.png[role="popup-link"]
...
image::{img}developer-desktop-csv-import-orders_convert.png[role="popup-link"]
...
image::{img}developer-desktop-csv-import-details_convert.png[role="popup-link"]
...
image::{img}developer-desktop-csv-import-data_model.png[role="popup-link"]
...
image::{img}developer-desktop-csv-import-verify_products.png[role="popup-link"]
...
image::{img}developer-desktop-csv-import-verify_orders.png[role="popup-link"]
...
image::{img}developer-desktop-csv-import-verify_details.png[role="popup-link"]
