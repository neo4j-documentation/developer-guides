...
[TIP]
====
_Neo4j Bloom is now available for free in https://neo4j.com/download/[Neo4j Desktop^], and is also available in https://neo4j.com/cloud/aura[Neo4j AuraDB^]. https://neo4j.com/developer/neo4j-bloom/[This guide^] will provide more information on getting started._
====
