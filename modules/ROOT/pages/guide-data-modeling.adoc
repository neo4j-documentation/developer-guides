...
[source,Cypher]
----
MERGE (j:Person {name: 'John', age: 27})
MERGE (s:Person {name: 'Sally', age: 32})
MERGE (b:Book {title: 'Graph Databases', authors: ['Jim Webber', 'Ian Robinson']})
...
image:{img}/ImplementedModel.png[]
