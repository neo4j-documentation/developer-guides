...
:page-deprecated-redirect: https://neo4j.com/docs/getting-started/current/data-modeling/relational-to-graph-modeling/
...
A walkthrough of designs for different use cases is in our
ifndef::env-guide[]
xref:modeling-designs.adoc[modeling designs^]
endif::[]
ifdef::env-guide[]
https://neo4j.com/developer/modeling-designs/[modeling designs^]
endif::[]
guide.
...
*  https://graphacademy.neo4j.com/courses/modeling-fundamentals/[Data Modeling Fundamentals^] course on GraphAcademy
