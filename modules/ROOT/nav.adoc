...
* Courses
** link:https://neo4j.com/graphacademy/online-training/introduction-to-neo4j-40/[Intro Neo4j^]
...
* Courses
** link:https://neo4j.com/graphacademy/online-training/introduction-to-neo4j-40/[1. Intro Neo4j^]
** link:https://neo4j.com/graphacademy/online-training/graph-data-modeling/[2. Graph Data Modeling^]
** link:https://neo4j.com/graphacademy/online-training/implementing-graph-data-models-40/[3. Implementing Models^]
...
* Courses
** link:https://neo4j.com/graphacademy/online-training/introduction-to-neo4j-40/[1. Intro Neo4j^]
** link:https://neo4j.com/graphacademy/online-training/intro-graph-algos-40/[2. Graph Algorithms^]
...
** link:https://neo4j.com/graphacademy/online-training/introduction-to-neo4j-40/[2. Intro Neo4j^]
