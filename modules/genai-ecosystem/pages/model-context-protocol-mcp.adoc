...
* https://hub.docker.com/mcp/server/neo4j/overview[Docker MCP Catalog^]
...
The official MCP Server for Neo4j, is a local MCP server that is downloadable as a binary and works with all types of Neo4j Deployments - Neo4j Aura, Self Managed, Docker, Neo4j Desktop, and Neo4j Sandbox.
The repository README has installation instructions including the necessary environment variables for common MCP Hosts like Claude Desktop, VS Code and others.
...
- stdio and http transport (incl. custom SSL certificates)

Links:

- https://github.com/neo4j/mcp[GitHub Repository^]
- https://github.com/neo4j/mcp/issues[GitHub Issues^]
- https://github.com/neo4j/mcp/releases[Download^]
- https://neo4j.com/docs/mcp/current/[Neo4j MCP Documentation^]
- https://medium.com/neo4j/how-to-deploy-the-neo4j-mcp-server-to-gcp-cloud-run-c2736fdee6ac[Deploying Neo4j MCP on GCP Cloud Run^]
...
Since then we have added https://github.com/neo4j-contrib/mcp-neo4j[several more Labs MCP servers^], to control the Neo4j Aura API and to store memories as a knowledge graph in Neo4j.

Neo4j also integrated with Google's MCP Toolbox to provide better tool integration for graph databases.
...
++++
<iframe width="280" height="160" src="https://www.youtube.com/embed/wtGmzoRRtXs?si=--REl22N1JcxXra4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
++++
...
image::https://dev.assets.neo4j.com/wp-content/uploads/data-modeling-process-v2.png[width=400]
