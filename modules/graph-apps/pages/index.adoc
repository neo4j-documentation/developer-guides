...
You will learn about the Neo4j JavaScript Driver, how sessions and transactions work and how to query Neo4j in a TypeScript application.

link:https://graphacademy.neo4j.com/courses/app-typescript/?ref=guides[Learn more^,role=button]
