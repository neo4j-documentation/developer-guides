...
[source,python]
----
include::example$link-prediction/py/05_SageMaker.py[tag="imports"]
...
[source,python]
----
include::example$link-prediction/py/05_SageMaker.py[tag="autopilot-track-progress"]
----
...
[source,python]
----
include::example$link-prediction/py/05_SageMaker.py[tag="autopilot-all-candidates"]
----

.All candidates
[format="csv", options="header", cols="4,1"]
|===
include::example$link-prediction/notebooks/data/autopilot_candidates.csv[]
|===
...
[source,python]
----
include::example$link-prediction/py/05_SageMaker.py[tag="autopilot-best-candidate"]
----

.Best candidate
[format="csv", options="header", cols="3,1,1"]
|===
include::example$link-prediction/notebooks/data/autopilot_best_candidate.csv[]
|===
...
[source,python]
----
include::example$link-prediction/py/05_SageMaker.py[tag="autopilot-create-model"]
----
...
[source,python]
----
include::example$link-prediction/py/05_SageMaker.py[tag="autopilot-create-transform-job"]
----
...
[source,python]
----
include::example$link-prediction/py/05_SageMaker.py[tag="autopilot-track-transform-job"]
----
...
[source,python]
----
include::example$link-prediction/py/05_SageMaker.py[tag="autopilot-transform-job-results"]
----
...
[source,python]
----
include::example$link-prediction/py/05_SageMaker.py[tag="evaluation-imports"]

include::example$link-prediction/py/05_SageMaker.py[tag="evaluation-functions"]
----
...
[source,python]
----
include::example$link-prediction/py/05_SageMaker.py[tag="test-model"]
----
