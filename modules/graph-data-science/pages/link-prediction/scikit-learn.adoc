...
[source,python]
----
include::example$link-prediction/02_Co-Author_Graph.py[tag="imports"]

include::example$link-prediction/02_Co-Author_Graph.py[tag="driver"]

include::example$link-prediction/02_Co-Author_Graph.py[tag="data-import"]
----
...
[source,python]
----
include::example$link-prediction/03_Train_Test_Split.py[tag="imports"]

include::example$link-prediction//03_Train_Test_Split.py[tag="determine-split"]
----
...
[source,python]
----
include::example$link-prediction/03_Train_Test_Split.py[tag="sub-graphs"]
----
...
[source,python]
----
include::example$link-prediction/03_Train_Test_Split.py[tag="positive-negative-examples"]
----
...
[source,python]
----
include::example$link-prediction/03_Train_Test_Split.py[tag="count-positive-negative"]
----
...
[source,python]
----
include::example$link-prediction/03_Train_Test_Split.py[tag="down-sample"]
----
...
[source,python]
----
include::example$link-prediction/03_Train_Test_Split.py[tag="test-positive-negative-examples"]

include::example$link-prediction/03_Train_Test_Split.py[tag="count-test-positive-negative"]

include::example$link-prediction/03_Train_Test_Split.py[tag="down-sample-test"]
----
...
[source,python]
----
include::example$link-prediction/03_Train_Test_Split.py[tag="train-preview"]

include::example$link-prediction/03_Train_Test_Split.py[tag="test-preview"]
----
...
* Link prediction measures - features from running the link prediction algorithms
* Triangles and Clustering Coefficient - features from running the triangles and clustering coefficient algorithms
* Community Detection - features from running the Louvain and Label Propagation algorithms
...
[source,python]
----
include::example$link-prediction/04_Model_Feature_Engineering.py[tag="graphy-features"]

include::example$link-prediction/04_Model_Feature_Engineering.py[tag="apply-graphy-features"]
----
...
[source,python]
----
include::example$link-prediction/04_Model_Feature_Engineering.py[tag="train-triangles"]

include::example$link-prediction/04_Model_Feature_Engineering.py[tag="test-triangles"]
----

.Clustering Coefficient
[source,python]
----
include::example$link-prediction/04_Model_Feature_Engineering.py[tag="train-coefficient"]

include::example$link-prediction/04_Model_Feature_Engineering.py[tag="test-coefficient"]
----
...
[source,python]
----
include::example$link-prediction/04_Model_Feature_Engineering.py[tag="triangles-coefficient-features"]

include::example$link-prediction/04_Model_Feature_Engineering.py[tag="apply-triangles-coefficient-features"]
----
...
[source,python]
----
include::example$link-prediction/04_Model_Feature_Engineering.py[tag="train-lpa"]

include::example$link-prediction/04_Model_Feature_Engineering.py[tag="test-lpa"]
----
...
[source,python]
----
include::example$link-prediction/04_Model_Feature_Engineering.py[tag="train-louvain"]

include::example$link-prediction/04_Model_Feature_Engineering.py[tag="test-louvain"]
----
...
[source,python]
----
include::example$link-prediction/04_Model_Feature_Engineering.py[tag="community-features"]

include::example$link-prediction/04_Model_Feature_Engineering.py[tag="apply-community-features"]
----
...
[source,python]
----
include::example$link-prediction/05_Train_Evaluate_Model.py[tag="imports"]

include::example$link-prediction/05_Train_Evaluate_Model.py[tag="create-classifier"]
----
...
[source,python]
----
include::example$link-prediction/05_Train_Evaluate_Model.py[tag="train-model"]
----

[#evaluate-model]
== Model Evaluation

We’re going to compute the model's accuracy, precision, and recall.
The diagram below, taken from the O’Reilly Graph Algorithms Book, explains how each of these metrics are computed.

.Accuracy measures
image::model-evaluation.png[]

scikit-learn has built in functions that we can use for this.
We can also return the importance of each feature used in our model.
The following functions will help with this:

[source,python]
----
include::example$link-prediction/05_Train_Evaluate_Model.py[tag="evaluation-imports"]

include::example$link-prediction/05_Train_Evaluate_Model.py[tag="evaluation-functions"]
----
...
[source,python]
----
include::example$link-prediction/05_Train_Evaluate_Model.py[tag="test-model"]
----

.Results
[opts=header, cols="3,2"]
|===
| Measure | Score
|	Accuracy	| 0.964
| Precision	| 0.961
