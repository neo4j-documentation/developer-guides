...
|===
include::example$link-prediction/data/df_train_under_basic_sample.csv[]
|===
...
[source,python]
----
include::example$link-prediction/04_Model_Feature_Engineering.py[tag="train-after-features"]
----

.Train DataFrame
[opts=header, format="csv", cols="5,17,15,17,15,6,5,5,5,10"]
|===
include::example$link-prediction/data/df_train_under_sample.csv[]
|===

[source,python]
----
include::example$link-prediction/04_Model_Feature_Engineering.py[tag="test-after-features"]
----

.Test DataFrame
[opts=header, format="csv", cols="5,17,15,17,15,6,5,5,5,10"]
|===
include::example$link-prediction/data/df_test_under_sample.csv[]
|===
...
|===
include::example$link-prediction/data/model-eval.csv[]
|===
