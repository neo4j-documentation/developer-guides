...
:page-aliases: ROOT:community-detection-graph-algorithms.adoc
:page-deprecated-title: the Neo4j Graph Data Science Library
:page-deprecated-redirect: https://neo4j.com/docs/graph-data-science/current/algorithms/community/
