...
| link:#random-projection[Fast Random Projection] | Fast |  Yes (in FastRPExtended) | Linear Algebra
...
link:/docs/graph-data-science/current/algorithms/fastrp/[Read Fast Random Projection reference documentation^, role="medium button"]
