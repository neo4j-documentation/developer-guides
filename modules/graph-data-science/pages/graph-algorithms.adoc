...
:page-deprecated-redirect: https://neo4j.com/docs/graph-data-science/current/algorithms/
...
* xref:graph-data-science:link-prediction/graph-data-science-library.adoc[]
