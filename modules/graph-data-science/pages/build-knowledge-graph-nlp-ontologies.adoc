...
image:apoc-small.jpg[float="right", width="100px"]
...
.Installing APOC
image::apoc-plugin-install.png[Installing APOC, link="{imagesdir}/apoc-plugin-install.png",role="popup-link"]
...
image::apoc-dependencies.png[Installing APOC NLP Depedencies, link="{imagesdir}/apoc-dependencies.png",role="popup-link"]
...
There are many different definitions of Knowledge Graphs.
...
.Zookeeper to NoSQL
image::zookeeper-nosql.png[Zookeeper to NoSQL, link="{imagesdir}/zookeeper-nosql",role="popup-link"]
