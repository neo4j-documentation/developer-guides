...
Now that you know the basics, use the parts below to build a cypher statement to to find the `title` and year of `release` for evert `:Movie` that Tom Hanks has `:DIRECTED`.
