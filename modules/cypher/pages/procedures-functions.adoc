...
:page-deprecated-redirect: https://neo4j.com/docs/getting-started/current/cypher-intro/procedures-functions/
...
That's why Neo4j and Cypher can be extended with User Defined Procedures and Functions.
