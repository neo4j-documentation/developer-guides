...
.Prerequisites
[abstract]
You should have a basic understanding of the xref:ROOT:graph-database.adoc#property-graph[property graph model]. Having Neo4j Desktop link:/download[downloaded^] and installed will allow you code along with the examples.
