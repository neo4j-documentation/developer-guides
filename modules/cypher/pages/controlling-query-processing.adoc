...
:page-deprecated-redirect: https://neo4j.com/docs/getting-started/current/cypher-intro/results/
...
* link:https://graphacademy.neo4j.com/courses/cypher-aggregation/[GraphAcademy Cypher Aggregations course^]
