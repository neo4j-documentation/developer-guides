...
It is akin to SQL for graphs, and incorporates all of the functionality you'd expect for manipulating graphs.

image:{img}sample-cypher.png[role="popup-link"]

Cypher is declarative and SQL-inspired, so it lets you focus on what data you want out of the graph (not how to go get it).
If you're already familiar with other query languages, picking up Cypher is a breeze because of the similarity to other languages.

What's different about Cypher is that it provides a visual way of matching patterns and relationships.  
...
:cta-header: Jump in and Learn by Doing
